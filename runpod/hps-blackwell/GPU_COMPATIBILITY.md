...
| RTX 5070/5080/5090 | 12.0 | ⚠️⁵ | ✅ | ❌ | ⚠️⁵ | Section 4 only — SM 120 PaddlePaddle available but no HPS Triton image yet |
...
⁵ PaddlePaddle SM 120 support added in paddleocr v3.5 via dedicated image (`paddleocr-vl:latest-nvidia-gpu-sm120`, CUDA 12.9 required). Section 4 deployment works. HPS (Triton) image not yet available for SM 120 — ringkasannet/paddleocr-hps will not work on Blackwell.
